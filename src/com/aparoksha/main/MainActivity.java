...
public class MainActivity extends Activity {
	...
	private static String[]				categories	= { "Development",
			"Robotics", "Networking", "Electronics", "Coding", "Misc" };

	/*
	 * categories = {"Electronics", "Robotics", "Misc",
	 */
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		linearLayout = (LinearLayout) findViewById(R.id.carousel_background);
		...
		carousel.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(CarouselAdapter<?> parent, View view,
				 ...
				 * String.format("%s has been clicked", ((CarouselItem)
				 * parent.getChildAt(position)) .getName()),
				 * Toast.LENGTH_SHORT).show();
				 */
				// switch (position) {

				// case 1:
				Intent i = new Intent("com.aparoksha.main.roboticsevents");
		...
		carousel.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(CarouselAdapter<?> parent, View view,
				...
				final TextView txt = (TextView) (findViewById(R.id.carousel_selected_item));
